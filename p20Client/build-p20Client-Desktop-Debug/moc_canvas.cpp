...
QT_MOC_LITERAL(3, 16, 6), // "setPen"
QT_MOC_LITERAL(4, 23, 10), // "setPenSize"
QT_MOC_LITERAL(5, 34, 6), // "sizeIn"
QT_MOC_LITERAL(6, 41, 8), // "clearAll"
QT_MOC_LITERAL(7, 50, 11) // "setKey_slot"

    },
    "canvas\0setText\0\0setPen\0setPenSize\0"
    "sizeIn\0clearAll\0setKey_slot"
};
...
void canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setText(); break;
        case 1: _t->setPen(); break;
        case 2: _t->setPenSize((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 3: _t->clearAll(); break;
        case 4: _t->setKey_slot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject canvas::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_canvas.data,
